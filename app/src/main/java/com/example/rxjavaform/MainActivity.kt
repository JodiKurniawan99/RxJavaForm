package com.example.rxjavaform
...
import com.example.rxjavaform.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val invalidFieldsStream = Observable.combineLatest(
            ...
            object : Function3<Boolean, Boolean, Boolean, Boolean> {
                override fun invoke(emailInvalid: Boolean, passwordInvalid: Boolean, passwordConfirmationInvalid: Boolean): Boolean {
                    return !emailInvalid && !passwordInvalid && !passwordConfirmationInvalid
                }
            })
